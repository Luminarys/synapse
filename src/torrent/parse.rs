...
use torrent::{Torrent, File};

pub fn torrent_from_bencode(data: BEncode) -> Result<Torrent, &'static str> {
    data.to_dict()
...
pub fn file_from_bencode(data: BEncode) -> Result<File, &'static str> {
