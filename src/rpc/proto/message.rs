...
pub enum CMessage {
    ...
    FilterSubscribe { serial: u64, criteria: Vec<Criterion> },
...
pub enum SMessage {
    ...
    UpdateResources { serial: u64, resources: Vec<Resource> },

    // Special messages
    TransferOffer { serial: u64, expires: DateTime<Utc>, token: String, size: u64 },
